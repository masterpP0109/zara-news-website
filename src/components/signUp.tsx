  ...
  return (
    <section className="bg-gray-50 py-16 w-full">
      <div className="maw-full mx-auto px-4 text-center">
        ...
        <div className="max-w-md mx-auto flex flex-col sm:flex-row gap-2 sm:gap-4">
             <input
            type="Name"
            placeholder="Name"
          ...
          <input
            ...
            className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-coral"
          />
          <Button className="bg-rose-400 py-2 rounded-[5px] hover:bg-coral/90 text-white px-6 sm:px-10">
            Subscribe Now
          </Button>
        </div>
      </div>
