  ...
  return (
    <div>
      ...
      <div className="w-[50vw] h-auto flex flex-wrap  justify-between gap-[16px] ">
        ...
        {featuredArticle ? (
          <Link href={`/blogs/${featuredArticle._id}`} className="flex flex-col flex-1 justify-center cursor-pointer hover:opacity-80 transition-opacity">
            ...
            <div className="bg-transparent text-blue-900 border-2 border-blue-900 font-bold px-6 py-2 rounded hover:bg-blue-900 hover:text-white transition-colors w-fit">
              Read More
            </div>
          </Link>
        ) : (
